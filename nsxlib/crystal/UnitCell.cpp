...
//
//! @file      nsxlib/crystal/UnitCell.cpp
//! @brief     Implements module/class/test UnitCell
//!
...
void UnitCell::printSelf(std::ostream& os) const
{
    ...
    os << "Direct Lattice:\n";
    os << std::fixed << std::setw(10) << std::setprecision(5) << c.a << "ang";
    os << std::fixed << std::setw(10) << std::setprecision(5) << c.b << "ang";
    os << std::fixed << std::setw(10) << std::setprecision(5) << c.c << "ang";
    os << std::fixed << std::setw(10) << std::setprecision(5) << c.alpha/deg << "deg";
    os << std::fixed << std::setw(10) << std::setprecision(5) << c.beta/deg << "deg";
    os << std::fixed << std::setw(10) << std::setprecision(5) << c.gamma/deg << "deg";
    os << std::endl;
    os << "Reciprocal Lattice:\n";
    os << std::fixed << std::setw(10) << std::setprecision(5) << rc.a << "ang-1";
    os << std::fixed << std::setw(10) << std::setprecision(5) << rc.b << "ang-1";
    os << std::fixed << std::setw(10) << std::setprecision(5) << rc.c << "ang-1";
    os << std::fixed << std::setw(10) << std::setprecision(5) << rc.alpha/deg << "deg";
    os << std::fixed << std::setw(10) << std::setprecision(5) << rc.beta/deg << "deg";
    os << std::fixed << std::setw(10) << std::setprecision(5) << rc.gamma/deg << "deg";
    os << std::endl;
