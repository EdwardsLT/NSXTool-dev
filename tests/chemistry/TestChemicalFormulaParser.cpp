...
//
//! @file      tests/chemistry/TestChemicalFormulaParser.cpp
//! @brief     Implements module/class/test TestChemicalFormulaParser
//!
...
int main()
{
    ...
    isotopes.clear();
    material = "X";
    NSX_CHECK_THROW(phrase_parse(material.begin(),material.end(),parser,blank,isotopes),std::runtime_error);
